...
Setting('LDAP_ADDRESS', 'ldap://localhost'); // Example value "ldap://vm-dc2019.local.berrnd.net"
Setting('LDAP_BASE_DN', 'dc=syncloud,dc=org'); // Example value "DC=local,DC=berrnd,DC=net"
Setting('LDAP_BIND_DN', 'cn=admin,dc=syncloud,dc=org'); // Example value "CN=grocy_bind_account,OU=service_accounts,DC=local,DC=berrnd,DC=net"
Setting('LDAP_BIND_PW', 'syncloud'); // Password for the above account
Setting('LDAP_USER_FILTER', '(objectclass=inetOrgPerson)'); // Example value "(OU=grocy_users)"
